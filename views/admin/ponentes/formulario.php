...
<fieldset class="formulario__fieldset">
    ...
    <div class="campo">
        <label for="tags-input" class="formulario__label">Areas de experiencia(separadas por coma):</label>
        <input type="text" class="formulario__input" id="tags-input" placeholder="Ej: NOde, Js, PHP, Javascript">
